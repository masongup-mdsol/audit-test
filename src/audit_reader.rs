...
async fn retrieve_many_audits_by_id(audit_ids: &[&str]) -> bool {
    ...
    let num_responses = batch_result
        ...
        .len();
    println!(
        "Got responses: {} to {} audits requested",
            ...
            match query_res {
                Ok(result) => {
                    ...
                    total_read_cap_units +=
                        result.consumed_capacity.unwrap().capacity_units.unwrap();
