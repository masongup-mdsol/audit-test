...
impl MAuthInfo {
    ...
    pub fn sign_request(&self, req: &mut Request<Body>, body_digest: String) {
    ...
    pub fn validate_response(&self, response: Response<Body>, mut runtime: &mut Runtime) -> Result<String, MAuthValidationError> {
